  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-purple-50 p-6">
      <form onSubmit={submit} className="w-full max-w-md bg-white p-6 rounded-xl shadow">
        ...
        <input required value={form.name} onChange={e=>setForm({...form,name:e.target.value})} placeholder="Нэр" className="w-full p-3 border rounded mb-3" />
        ...
        <button className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded font-semibold">Бүртгүүлэх</button>
      </form>
    </div>
  );
}
